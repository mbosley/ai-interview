  ...
  return (
    <div className="flex flex-col min-h-[640px] bg-white font-sans">
      <div className="flex justify-between items-center px-6 py-4 border-b border-gray-100">
        ...
        <div className="text-xs uppercase tracking-wider text-gray-500">How It Works</div>
      ...
      <div className="flex-1 overflow-auto">
        <div className="px-6 pt-8 pb-12 space-y-12">
          ...
          <div className="flex flex-col items-center border-b border-gray-100 pb-12">
            <div className="w-12 h-12 bg-gray-100 flex items-center justify-center mb-4">
              <span className="text-gray-800 text-xl">1</span>
            </div>
            <h2 className="text-lg font-normal text-gray-900 mb-2">Sign Up</h2>
            ...
            <img src="/api/placeholder/300/180" alt="Sign up illustration" className="border border-gray-200" />
          </div>
          ...
          <div className="flex flex-col items-center border-b border-gray-100 pb-12">
            ...
            <h2 className="text-lg font-normal text-gray-900 mb-2">Select Interviews</h2>
            <p className="text-center text-gray-600 mb-6">
              Browse available interviews based on topics that interest you. Each interview shows the estimated time and compensation.
            </p>
            <img src="/api/placeholder/300/180" alt="Select interviews illustration" className="border border-gray-200" />
          </div>
          ...
          <div className="flex flex-col items-center border-b border-gray-100 pb-12">
            ...
            <h2 className="text-lg font-normal text-gray-900 mb-2">Have a Conversation</h2>
            <p className="text-center text-gray-600 mb-6">
            ...
            <img src="/api/placeholder/300/180" alt="Conversation illustration" className="border border-gray-200" />
          </div>
          ...
          <div className="flex flex-col items-center border-b border-gray-100 pb-12">
            ...
            <h2 className="text-lg font-normal text-gray-900 mb-2">Get Paid</h2>
            <p className="text-center text-gray-600 mb-6">
            ...
            <img src="/api/placeholder/300/180" alt="Payment illustration" className="border border-gray-200" />
          </div>
          
          <div className="border border-gray-200 p-6">
            <h3 className="text-lg font-normal text-gray-900 mb-3">Your Privacy Matters</h3>
