  ...
  return (
    <div className="flex flex-col min-h-[640px] bg-white font-sans">
      <div className="flex justify-between items-center px-6 py-4 border-b border-gray-100">
        ...
        <div className="text-sm text-gray-500 font-light">Interview Complete</div>
      ...
      <div className="px-6 mb-10">
        <div className="border border-gray-100 rounded-md p-6">
          <h2 className="text-xs uppercase tracking-wider text-gray-400 mb-2">PAYMENT SUMMARY</h2>
          <div className="text-2xl font-light text-gray-900 mb-4">$15.00</div>
      ...
      <div className="px-6 mb-10">
        <h2 className="text-xs uppercase tracking-wider text-gray-400 mb-3">YOUR CONTRIBUTION</h2>
        ...
        <button 
          className="w-full bg-white text-gray-800 font-normal text-base py-3.5 px-4 rounded-md transition-all duration-150 border border-gray-200 hover:bg-gray-50"
      ...
      <div className="px-6 mt-auto mb-8">
        <div className="space-y-3">
          <button
            className="w-full bg-black text-white font-normal text-base py-3.5 px-4 rounded-md transition-all duration-150 hover:bg-gray-900"
